...
for(tissue in c('t60-adrenal','t52-hippocampus','t53-cortex','t54-hypothalamus','t55-gastrocnemius',
                't56-vastus-lateralis','t58-heart','t59-kidney','t61-colon','t62-spleen',
                't65-aorta','t66-lung','t67-small-intestine','t68-liver',
                't69-brown-adipose','t70-white-adipose','t64-ovaries','t63-testes')){
        ...
        col_data <- col_data %>%
                ...
                mutate(Specimen.Processing.sampletypedescription = 
                               ifelse(Specimen.Processing.sampletypedescription == 'Adrenals', 'Adrenal',
