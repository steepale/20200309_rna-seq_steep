...
if(length(args)!=3){
        stop('Not enough args supplied: tissue, sex, nCores')
}
TISSUE = gsub('_',' ',args[1]) # e.g. 'gastrocnemius', 'white adipose'
SEX = args[2] # one of {'male', 'female', 'all'}
...
source('impulse_fx.R') # load ancillary functions 
